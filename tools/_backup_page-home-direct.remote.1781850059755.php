...
// Slider giới thiệu công ty — 6 ảnh thực tế đội ngũ, cập nhật 2026-05-29
$intro_slider_images = [
    ...
    ['src' => 'https://thongtaccongquangninh.com/wp-content/uploads/2026/05/doi-ngu-ky-thuat-moi-truong-do-thi-quang-ninh-san-sang-phuc-vu-24-7.webp',      'alt' => 'Đội ngũ kỹ thuật Môi Trường Đô Thị Số 1 Quảng Ninh sẵn sàng phục vụ 24/7'],
...
$facebook_url            = 'https://www.facebook.com/thongtacconghalong24h';
...
$faq_items = [
    ...
    [
        'question' => 'Có phục vụ ngoài giờ hành chính và ban đêm không?',
        'answer'   => 'Có. Đội kỹ thuật phục vụ 24/7 kể cả ngày lễ, Tết và ban đêm.',
    ],
    [
...
<nav class="home-nav ttcqn-nav" role="navigation" aria-label="Điều hướng chính">
  <div class="nav-inner ttcqn-nav-inner">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="nav-logo seo-header-logo ttcqn-brand" aria-label="Trang chủ Môi Trường Đô Thị Số 1 Quảng Ninh">
      <img src="<?php echo esc_url($header_logo_rendered_url); ?>" alt="Môi Trường Đô Thị Số 1 Quảng Ninh - Uy tín nhanh chóng sạch sẽ" class="ttcqn-brand-full-logo" width="356" height="94" loading="eager" fetchpriority="high" decoding="async">
    </a>
...
echo ttcqn_seo_hero_render([
    'title' => 'HÚT BỂ PHỐT, THÔNG TẮC CỐNG QUẢNG NINH 24/7',
    ...
    <div class="ttcqn-intro-grid">
      ...
      <div class="ttcqn-intro-content-col">
        ...
        <div class="ttcqn-intro-cta-group">
          <a href="tel:0963953533" class="ttcqn-intro-btn-primary" aria-label="Gọi đội thợ 24/7 qua hotline 0963.953.533">
...
<section class="ttcqn-services-section" aria-labelledby="sv-title" id="dich-vu">
  ...
  <div class="ttcqn-benefit-strip" aria-label="Liên kết nhanh hỗ trợ khách hàng">
    <a class="ttcqn-benefit-cell" href="<?php echo esc_url($home_internal_links['contact']); ?>" aria-label="Gửi yêu cầu dịch vụ">
      <span class="ttcqn-benefit-icon has-image"><img src="<?php echo esc_url($service_benefit_icon_urls['contact']); ?>" alt="Biểu tượng gửi yêu cầu dịch vụ 24/7" width="92" height="92" loading="lazy" decoding="async"></span>
      <span><strong>Gửi yêu cầu dịch vụ</strong><small>Điều phối kỹ thuật viên 24/7</small></span>
    </a>
    <a class="ttcqn-benefit-cell" href="<?php echo esc_url($home_internal_links['price']); ?>" aria-label="Xem bảng giá hút bể phốt, thông tắc cống">
      <span class="ttcqn-benefit-icon has-image"><img src="<?php echo esc_url($service_benefit_icon_urls['price']); ?>" alt="Biểu tượng bảng giá dịch vụ môi trường" width="92" height="92" loading="lazy" decoding="async"></span>
    ...
    <a class="ttcqn-benefit-cell" href="<?php echo esc_url($home_internal_links['warranty']); ?>" aria-label="Xem chính sách bảo hành dịch vụ">
      <span class="ttcqn-benefit-icon has-image"><img src="<?php echo esc_url($service_benefit_icon_urls['warranty']); ?>" alt="Biểu tượng chính sách bảo hành dịch vụ" width="92" height="92" loading="lazy" decoding="async"></span>
    ...
    <a class="ttcqn-benefit-cell" href="<?php echo esc_url($home_internal_links['blog']); ?>" aria-label="Xem cẩm nang xử lý tắc nghẽn">
      <span class="ttcqn-benefit-icon has-image"><img src="<?php echo esc_url($service_benefit_icon_urls['blog']); ?>" alt="Biểu tượng cẩm nang xử lý tắc nghẽn" width="92" height="92" loading="lazy" decoding="async"></span>
...
<section class="section-white ttcqn-region-section" aria-labelledby="about-title">
  <div class="slider-about-wrap">
    ...
    <div class="about-text-side anim-right">
      ...
      <h2 id="about-title"><span>PHỤC VỤ <em>24/7</em></span><span>TẠI QU���NG NINH</span></h2>
  ...
  <div class="ttcqn-projects-inner">
    ...
    <div class="ttcqn-project-cta">
      ...
      <div class="ttcqn-project-cta-copy">
        ...
        <p>Chúng tôi sẵn sàng hỗ trợ 24/7 – Có mặt nhanh chóng!</p>
  ...
  <div class="ttcqn-area-container">
    ...
    <div class="ttcqn-area-benefits">
      ...
      <div class="ttcqn-area-benefit">
        ...
        <span><strong>Hotline 24/7</strong><br>0963.953.533</span>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="ttcqn-handbook-container">
    ...
    <div class="ttcqn-handbook-trust anim" aria-label="Cam kết dịch vụ">
      <article class="ttcqn-handbook-trust-item">
        ...
        <div><h3>Có mặt nhanh</h3><p>Phục vụ 24/7, có mặt chỉ sau 30 phút</p></div>
      </article>
      <article class="ttcqn-handbook-trust-item">
    ...
    $handbook_cards = [
      [
        'category' => 'TẮC CỐNG',
        'title' => 'Thông tắc cống Giếng Đáy Hạ Long 24/7, thợ xử lý tận nơi nhanh',
      ...
      [
        ...
        'title' => 'Thông tắc cống Cao Xanh 24/7, không đục phá, có mặt nhanh 15–30 phút',
        'excerpt' => 'Thông tắc cống Cao Xanh 24/7, không đục phá, báo giá rõ. Gọi 0963.953.533 / 0931.156.756 để xử lý tắc nghẽn, mùi hôi.',
      ...
      [
        ...
        'title' => 'Dịch vụ thông tắc cống Bãi Cháy 24/7, không đục phá, bảo hành 12 tháng',
        'excerpt' => 'Thông tắc cống Bãi Cháy 24/7, không đục phá, báo giá rõ. Gọi 0963.953.533 / 0931.156.756 xử lý tắc nghẽn, mùi hôi.',
      ...
      [
        ...
        'title' => 'Thông tắc cống Hồng Gai Hạ Long 24/7, khử mùi hôi triệt để, bảo hành 12 tháng',
      ...
      [
        ...
        'title' => 'Hút bể phốt Hải Hà Quảng Ninh 24/7, giá rõ trước khi làm',
...
<!-- ========== KHÁCH HÀNG NÓI GÌ ========== -->
<?php
$testimonial_avatar_files = [
    'hung'      => 'testimonial-anh-tran-hung.webp',
    'lan'       => 'testimonial-chi-nguyen-lan.webp',
    'phong'     => 'testimonial-anh-vu-phong.webp',
    'chat_lan'  => 'testimonial-chat-chi-lan.webp',
    'chat_hung' => 'testimonial-chat-anh-hung.webp',
    'chat_mai'  => 'testimonial-chat-chi-mai.webp',
];
$testimonial_avatar_base = 'https://thongtaccongquangninh.com/wp-content/plugins/ttcqn-home-emergency-renderer/assets/testimonials/';
$testimonial_avatars = [];
foreach ($testimonial_avatar_files as $testimonial_avatar_key => $testimonial_avatar_file) {
    $testimonial_avatars[$testimonial_avatar_key] = $testimonial_avatar_base . $testimonial_avatar_file;
}
if (function_exists('plugins_url') && basename(__DIR__) === 'templates') {
    $home_renderer_main_file = dirname(__DIR__) . '/ttcqn-home-emergency-renderer.php';
    $home_renderer_testimonial_dir = dirname(__DIR__) . '/assets/testimonials';
    foreach ($testimonial_avatar_files as $testimonial_avatar_key => $testimonial_avatar_file) {
        if (file_exists($home_renderer_testimonial_dir . '/' . $testimonial_avatar_file)) {
            $testimonial_avatars[$testimonial_avatar_key] = plugins_url('assets/testimonials/' . $testimonial_avatar_file, $home_renderer_main_file);
        }
    }
}
$chat_reviews = [
    [
        'name' => 'Chị Lan - Hạ Long',
        'status' => 'Truy cập 10:43',
        'avatar' => $testimonial_avatars['chat_lan'],
        'avatar_alt' => 'Ảnh đại diện Chị Lan trong tin nhắn phản hồi',
        'service' => 'Bên em đã xử lý xong rồi ạ, chị kiểm tra giúp em nhé.',
        'service_time' => '10:21',
        'customer' => 'Ok em, bên em làm nhanh thật. Gọi chưa đến 30 phút đã có mặt.',
        'customer_time' => '10:28',
    ],
    [
        'name' => 'Anh Hùng - Cẩm Phả',
        'status' => 'Vừa mới truy cập',
        'avatar' => $testimonial_avatars['chat_hung'],
        'avatar_alt' => 'Ảnh đại diện Anh Hùng trong tin nhắn phản hồi',
        'service' => 'Bên em cảm ơn anh đã sử dụng dịch vụ. Anh thấy công việc hôm nay ổn chứ ạ?',
        'service_time' => '09:15',
        'customer' => 'Ổn em nhé. Bể phốt đầy mà bên em đến rất nhanh.',
        'customer_time' => '09:18',
    ],
    [
        'name' => 'Chị Mai - Uông Bí',
        'status' => 'Đang hoạt động',
        'avatar' => $testimonial_avatars['chat_mai'],
        'avatar_alt' => 'Ảnh đại diện Chị Mai trong tin nhắn phản hồi',
        'service' => 'Dạ bên em xin hỏi chị sau khi xử lý cống thoát sàn, hiện tại nước thoát ổn chưa ạ?',
        'service_time' => '09:45',
        'customer' => 'Ổn rồi em nhé, nước rút nhanh hơn hẳn.',
        'customer_time' => '10:47',
    ],
];
?>
<section class="ttcqn-reviews-section" aria-labelledby="review-title">
  ...
  <div class="ttcqn-reviews-container">
    <div class="ttcqn-reviews-header">
      <span class="ttcqn-reviews-badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 4c-7.5.3-12.5 3.2-14.7 8.8C3.7 16.8 6.7 20 10.6 19.4 16.2 18.5 19.7 12.6 20 4Z"/><path d="M6 18c3.8-5 7.8-8 12-9"/></svg>KHÁCH HÀNG</span>
      <h2 class="ttcqn-reviews-title anim" id="review-title">KHÁCH HÀNG <span>NÓI GÌ?</span></h2>
      <p class="ttcqn-reviews-desc anim">Những phản hồi thực tế từ khách hàng đã sử dụng dịch vụ tại Hạ Long, Cẩm Phả, Uông Bí và toàn tỉnh Quảng Ninh.</p>
      <div class="ttcqn-reviews-underline" aria-hidden="true"></div>
    </div>

    <div class="ttcqn-reviews-grid">
      <article class="ttcqn-review-card">
        <div class="ttcqn-review-stars" aria-label="5 sao">
        ...
        <p class="ttcqn-review-text">Dịch vụ rất nhanh, gọi 30 phút đã có mặt. Giá hợp lý, thợ làm sạch sẽ, không để lại bẩn.</p>
        <footer class="ttcqn-review-author">
          <span class="ttcqn-review-avatar">
            <img src="<?php echo esc_url($testimonial_avatars['hung']); ?>" alt="Ảnh đại diện khách hàng Anh Trần Hùng" width="58" height="58" loading="lazy" decoding="async">
          </span>
          <div class="ttcqn-review-meta">
            <p class="ttcqn-review-name">Anh Trần Hùng</p>
            <p class="ttcqn-review-loc"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22s7-6.1 7-12a7 7 0 0 0-14 0c0 5.9 7 12 7 12Z"/><circle cx="12" cy="10" r="2.4"/></svg>Hạ Long, Quảng Ninh</p>
          </div>
        </footer>
      </article>
      ...
      <article class="ttcqn-review-card">
        ...
        <p class="ttcqn-review-text">Bể phốt đầy, gọi là đến ngay. Xử lý sạch sẽ, có bảo hành rõ ràng. Sẽ gọi lại lần sau!</p>
        <footer class="ttcqn-review-author">
          <span class="ttcqn-review-avatar">
            <img src="<?php echo esc_url($testimonial_avatars['lan']); ?>" alt="Ảnh đại diện khách hàng Chị Nguyễn Lan" width="58" height="58" loading="lazy" decoding="async">
          </span>
          <div class="ttcqn-review-meta">
            <p class="ttcqn-review-name">Chị Nguyễn Lan</p>
            <p class="ttcqn-review-loc"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22s7-6.1 7-12a7 7 0 0 0-14 0c0 5.9 7 12 7 12Z"/><circle cx="12" cy="10" r="2.4"/></svg>Cẩm Phả, Quảng Ninh</p>
          </div>
        </footer>
      </article>
      ...
      <article class="ttcqn-review-card">
        ...
        <p class="ttcqn-review-text">Cống tắc nặng, nhiều bên không xử lý được. Bên này dùng máy cao áp, xử lý sạch hoàn toàn.</p>
        <footer class="ttcqn-review-author">
          <span class="ttcqn-review-avatar">
            <img src="<?php echo esc_url($testimonial_avatars['phong']); ?>" alt="Ảnh đại diện khách hàng Anh Vũ Phong" width="58" height="58" loading="lazy" decoding="async">
          </span>
          <div class="ttcqn-review-meta">
            <p class="ttcqn-review-name">Anh Vũ Phong</p>
            <p class="ttcqn-review-loc"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22s7-6.1 7-12a7 7 0 0 0-14 0c0 5.9 7 12 7 12Z"/><circle cx="12" cy="10" r="2.4"/></svg>Uông Bí, Quảng Ninh</p>
          </div>
        </footer>
      </article>
    </div>

    <div class="ttcqn-chat-heading">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/><path d="M8 9h8M8 13h5"/></svg>
      TIN NHẮN PHẢN HỒI THỰC TẾ
    </div>

    <div class="ttcqn-chat-grid">
      <?php foreach ($chat_reviews as $chat_review) : ?>
      <article class="ttcqn-chat-card">
        <header class="ttcqn-chat-header">
          <span class="ttcqn-chat-avatar">
            <img src="<?php echo esc_url($chat_review['avatar']); ?>" alt="<?php echo esc_attr($chat_review['avatar_alt']); ?>" width="36" height="36" loading="lazy" decoding="async">
          </span>
          <div class="ttcqn-chat-person">
            <p class="ttcqn-chat-name"><?php echo esc_html($chat_review['name']); ?></p>
            <p class="ttcqn-chat-status"><?php echo esc_html($chat_review['status']); ?></p>
          </div>
          <div class="ttcqn-chat-actions" aria-hidden="true">
            ...
            <span class="ttcqn-chat-dots">•••</span>
          </div>
        </header>
        <div class="ttcqn-chat-body">
          <div class="ttcqn-chat-bubble is-service">
            <?php echo esc_html($chat_review['service']); ?>
            <span class="ttcqn-chat-time"><?php echo esc_html($chat_review['service_time']); ?><span class="ttcqn-chat-read">✓✓</span></span>
          </div>
          <div class="ttcqn-chat-bubble is-customer">
            <?php echo esc_html($chat_review['customer']); ?>
            <span class="ttcqn-chat-time"><?php echo esc_html($chat_review['customer_time']); ?></span>
          </div>
        </div>
      </article>
      <?php endforeach; ?>
    ...
    <div class="ttcqn-reviews-more">
      <a class="ttcqn-reviews-more-btn" href="<?php echo esc_url(home_url('/#footer')); ?>" aria-label="Xem thêm phản hồi khách hàng">
        XEM THÊM PHẢN HỒI
    ...
    <div class="mtdt-about-team-grid">
      ...
      <article class="mtdt-about-member-card<?php echo !empty($team_member['leader']) ? ' is-leader' : ''; ?>">
        ...
        <div class="mtdt-about-member-content">
          ...
          <div class="mtdt-about-rating" aria-label="<?php echo esc_attr('Đánh giá ' . $team_member['score']); ?>">
            <span class="mtdt-about-stars">★★★★★</span>
            <span class="mtdt-about-score"><?php echo esc_html($team_member['score']); ?></span>
          </div>
  ...
  <div class="ttcqn-trust-container">
    ...
    <div class="ttcqn-trust-cta-banner">
      ...
      <div class="ttcqn-trust-cta-mid">
        ...
        <span class="ttcqn-trust-cta-sub">Tư vấn & báo giá miễn phí 24/7</span>
      </div>
...
<section class="section-gray section-wave-bottom wave-to-blue" aria-labelledby="faq-title">
  ...
  <details class="faq-item anim"><summary>Có phục vụ ngoài giờ hành chính và ban đêm không?</summary><p>Có. Bên mình nhận việc 24/7, kể cả đêm muộn, ngày lễ hay Tết, để khi nhà bạn có sự cố là có người hỗ trợ ngay.</p></details>
...
<footer class="home-footer" id="footer" role="contentinfo">
  ...
  <div class="footer-shell">
    <section class="footer-support" aria-label="Hỗ trợ nhanh 24/7">
      <div class="footer-support-head">
        ...
        <div>
          ...
          <p class="footer-support-title">Gọi chúng tôi 24/7</p>
        </div>
      </div>
      ...
      <div class="footer-support-items">
        ...
        <article class="footer-support-item">
          ...
          <div>
            ...
            <p class="footer-support-main">24/7 - Kể cả ngày lễ</p>
      ...
      <div class="footer-main-grid">
        <div class="footer-brand-col">
          ...
          <ul class="footer-contact-list" aria-label="Thông tin liên hệ">
            ...
            <li><svg class="footer-icon" aria-hidden="true"><use href="#ft-clock"></use></svg><span>Phục vụ 24/7 - Có mặt nhanh chóng</span></li>
          </ul>
        ...
        <aside class="footer-commit-card" aria-label="Cam kết của chúng tôi">
          ...
          <ul class="footer-commit-list">
            ...
            <li><svg class="footer-icon" aria-hidden="true"><use href="#ft-check"></use></svg><span>Hỗ trợ 24/7 - kể cả ngày lễ</span></li>
          </ul>
        </aside>
...
var footerBackTop = document.querySelector('.footer-back-top');
if (footerBackTop) {
  if (footerBackTop.parentElement !== document.body) {
    document.body.appendChild(footerBackTop);
  }
