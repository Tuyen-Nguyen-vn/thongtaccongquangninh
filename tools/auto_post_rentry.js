...
// Đường dẫn bài viết nguồn tuyệt đối
const ARTICLE_PATH = "C:\\Users\\DELL\\.gemini\\antigravity\\brain\\53731f4b-93f7-4ee2-8da8-6de39a2eb744\\scratch\\post_cao_xanh_web2.md";
const LOG_FILE = "D:\\.thongtaccongquangninh\\docs\\BACKLINK_CAMPAIGN_LOG.json";

async function autoPostRentry() {
    console.log("====================================================");
    console.log("🚀 KHỞI ĐỘNG BỘ ĐĂNG BÀI WEB 2.0 TỰ ĐỘNG LÊN RENTRY.CO");
    console.log("====================================================");
...
function saveToCampaignLog(backlinkUrl, editCode, indexSuccess) {
    ...
    logs.unshift({
        ...
        editCode: editCode,
        targetUrl: "https://thongtaccongquangninh.com/thong-tac-cong-cao-xanh/",
