/**
 * Fetch nội dung page/post qua WP MCP ability.
 * Usage: node fetch_page_content.mjs <slug-or-id>
 */
...
const slugOrId = process.argv[2] ?? "chinh-sach-bao-hanh";

await req(auth, { jsonrpc: "2.0", id: 1, method: "initialize",
  params: { protocolVersion: "2024-11-05", capabilities: { tools: {} }, clientInfo: { name: "fetch", version: "1" } } });

const isId = /^\d+$/.test(slugOrId);
const r = await req(auth, { jsonrpc: "2.0", id: 2, method: "tools/call",
  params: { name: "wp-mcp-ultimate-execute-ability",
    arguments: { ability_name: isId ? "content/get-page" : "content/get-page",
      parameters: isId ? { id: Number(slugOrId) } : { slug: slugOrId } } } });
