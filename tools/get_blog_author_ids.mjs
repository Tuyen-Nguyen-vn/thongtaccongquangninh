...
// Blog page ID from WP settings
const settings = await wpReq("/wp-json/wp/v2/settings");
console.log("page_for_posts:", settings?.page_for_posts);
console.log("page_on_front:", settings?.page_on_front);

// Author user ID
const users = await wpReq("/wp-json/wp/v2/users?slug=nguyen-song-hao&_fields=id,slug,name");
console.log("Author:", JSON.stringify(users));
