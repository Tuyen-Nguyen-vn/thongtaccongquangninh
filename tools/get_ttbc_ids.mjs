...
const slugs=[
  "thong-tac-bon-cau-khach-san-quang-ninh-2026",
  "thong-tac-bon-cau-khong-duc-pha-quang-ninh",
  "thong-tac-bon-cau-nha-dan-quang-ninh-2026",
  "thong-tac-bon-cau-nha-hang-quang-ninh-2026",
];
for(const slug of slugs){
  const r=await wpGet(`/wp-json/wp/v2/posts?slug=${slug}&_fields=id,slug`);
  if(r[0]) console.log(`id=${r[0].id} slug=${r[0].slug}`);
