...
await mcpPost("initialize",{protocolVersion:"2024-11-05",capabilities:{},clientInfo:{name:"rmf",version:"1"}});
...
for(const slug of ["ttcqn-fix-meta-html","ttcqn-fix-meta-v2"]){
  const c=await call("read_file",{path:`/public_html/wp-content/plugins/${slug}/${slug}.php`});
  console.log(`\n===== ${slug} =====\n`+c);
}
