...
await mcpPost("initialize",{protocolVersion:"2024-11-05",capabilities:{},clientInfo:{name:"r282",version:"1"}});
...
const code=await call("read_file",{path:"/public_html/wp-content/plugins/ttcqn-title-override-282/ttcqn-title-override-282.php"});
console.log("=== ttcqn-title-override-282 ===");
console.log(code);
