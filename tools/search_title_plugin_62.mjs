...
await mcpPost("initialize",{protocolVersion:"2024-11-05",capabilities:{},clientInfo:{name:"srch",version:"1"}});
...
// Search plugin files for "gioi-thieu" or "page 62" or "Hồ sơ"
const r1=await call("search_files",{path:"/public_html/wp-content/plugins",query:"gioi-thieu",search_type:"content",max_results:20});
console.log("=== 'gioi-thieu' in plugins ===\n",r1.slice(0,1500));

const r2=await call("search_files",{path:"/public_html/wp-content/plugins",query:"Hồ sơ Môi Trường",search_type:"content",max_results:20});
console.log("\n=== 'Hồ sơ Môi Trường' in plugins ===\n",r2.slice(0,1500));

// Also check WP Rocket cache for gioi-thieu
const ls=await call("list_files",{path:"/public_html/wp-content/cache/wp-rocket/thongtaccongquangninh.com/gioi-thieu"});
console.log("\n=== gioi-thieu cache dir ===\n",ls.slice(0,600));
