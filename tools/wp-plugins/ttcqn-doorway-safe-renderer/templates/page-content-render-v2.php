...
<style id="ttcqn-doorway-safe-page-css">
    ...
    .ttcqn-doorway-safe-meta {
        margin: 0 0 18px;
        font-size: 14px;
        color: var(--ttcqn-color-muted, #627d98);
    }
...
<main id="primary" class="site-main ttcqn-doorway-safe-page">
    ...
    while (have_posts()) {
        ...
        if (function_exists('ttcqn_doorway_safe_byline')) {
            echo ttcqn_doorway_safe_byline((int) get_the_ID());
        }
        echo $content; // Trusted page HTML generated and stored by the SEO workflow.
        echo '</article>';
    }
    ?>
</main>
